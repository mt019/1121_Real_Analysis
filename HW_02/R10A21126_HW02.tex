...
such that \(|G|_e \leq |E|_e + \epsilon\). In general, since \(G = E \cup (G - E)\) when \(E \subset G\), we only have \(|G|_e \leq |E|_e + |G - E|_e\), and we cannot conclude from \(|G|_e \leq |E|_e + \epsilon\) that \(|G-E|_e < \epsilon\).
